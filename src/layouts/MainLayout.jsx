...
const MainLayout = () => {
    ...
    return (
        <div className="flex h-screen transition-all duration-300 bg-gradient-to-br from-purple-50 via-white to-blue-50">
            ...
            <div className="w-80 shadow-2xl transition-all duration-300 backdrop-blur-sm bg-gradient-to-b from-white via-gray-50 to-gray-100 border-r border-gray-200 relative z-30 h-full">

                <nav className="mt-6 flex flex-col justify-between h-full pb-8 overflow-y-auto px-4">
                    {/* GetWay section label */}
                    <div>
                        <div className="mb-4 px-2 py-5">
                            <div className="flex items-center">
                                <div className="flex-shrink-0 mr-3">
                                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-purple-500 via-purple-600 to-blue-600 flex items-center justify-center shadow-lg border border-purple-400/30">
                                        <img src="/logo.png" alt="GetWay" className="w-8 h-8 object-contain" />
                                    </div>
                                </div>
                                <span className="truncate transition-all duration-300 text-gray-800 text-3xl font-extrabold">
                                    GetWay
                                </span>
                            </div>
                        </div>
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                    ...
                    <div className="flex items-center justify-between px-6 py-5">
                        ...
                        <div className="flex items-center space-x-3 flex-shrink-0">
                            ...
                            <div className="p-2 transition-all duration-200 group text-gray-600 hover:text-gray-800 hover:bg-gray-200">
                                <div className="w-10 h-10 bg-gradient-to-br from-purple-500 via-purple-600 to-blue-600 rounded-full flex items-center justify-center text-white text-sm font-bold shadow-xl group-hover:scale-105 transition-transform border border-purple-400/30">
                ...
                {/* Main Content */}
                <main className="flex-1 overflow-y-auto bg-gradient-to-br from-gray-50 via-white to-purple-50 p-6">
